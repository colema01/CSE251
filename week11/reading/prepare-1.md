...
1. It is not required that you master learning C++, but you should familiarize yourself with how to create a `pthread` in C++.
2. Basic understanding of what a `MMap` is.
3. Basic understanding of what `Shared Memory` is.
4. See [Part 2](prepare-2.md)
